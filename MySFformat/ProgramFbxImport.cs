...
namespace MySFformat
{
    ...
    StringSplitOptions.None
            ...
            newBL.Add(new FLVER.LayoutMember(FLVER.LayoutType.Float3, FLVER.LayoutSemantic.Position, 0, 8));
            ...
            foreach (var m in md.Meshes)
            {
                ...
                if (setLOD == true)
                {
                    ...
                    {
                        FLVER2.FaceSet fs = generateBasicFaceSet();
                        fs.Flags = FLVER2.FaceSet.FSFlags.MotionBlur;
                        fs.Indices = mn.FaceSets[0].Indices;
                        mn.FaceSets.Add(fs);
                    }
